...
var AuthenticateUserService = /** @class */ (function () {
    ...
    AuthenticateUserService.prototype.execute = function (_a) {
        var email = _a.email, password = _a.password, isMobile = _a.isMobile;
        return __awaiter(this, void 0, void 0, function () {
            var token, userRepository, user, passwordMatched;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        user = _b.sent();
                        if (!user) {
                            throw new AppError_1.default('E-mail ou Senha Incorreto!', 401);
                        }
                    ...
                    case 2:
                        ...
                        if (isMobile) {
                            token = jsonwebtoken_1.sign({ id: user.id, license_at: user.license_at }, auth_1.default.jwt.secret, {
                                expiresIn: auth_1.default.jwtMobile.expiresIn
                            });
                        }
                        else {
                            token = jsonwebtoken_1.sign({ id: user.id, license_at: user.license_at }, auth_1.default.jwt.secret, {
